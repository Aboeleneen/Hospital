 ...
 <?php  
   ...
   $sql = $con->prepare("SELECT * FROM employees WHERE Role = 'Accountant' ");
        $sql->execute();
          ?>
    ...
    <div class="panel-body"> 
        <div  class="table-responsive ">
               <table class="datatable table table-striped table-bordered"  cellspacing="0" width="100%">
                 <h1 class="btn btn-success btn-block btn-lg" >Accountant List </h1>
                <thead>
                        <tr>
                            <th>NO</th>
                            <th>Picture</th>
   ...
   <?php    
        ...
        <tbody>
         ...
         <td><?php echo $row['email'];?></td>                        
             ...
             <td><a class="btn btn-primary" href="AccountantList.php?do=Edit&id=<?php echo $row['id'] ?>"> edit</a> 
                 <a class="btn btn-danger" href="AccountantList.php?do=delete&id=<?php echo $row['id'] ?>"> delete</a>
                 <a class="btn btn-info"   href="profile.php?id=<?php echo $row['id'] ?>&user=Employee&Role=Accountant"> show</a> </td> 
        </tr>
        <?php } ?></tbody>
      </table>
       </div>
     ...
     <?php  } else if($do == 'Edit'){
           ...
           $id = $_GET['id'];
           $sql = $con->prepare("SELECT * FROM employees Where id = ? AND Role = 'Accountant' ");
    ...
    <div id="main">
      <?php include 'navbar/navbar.php' ;?>
        ...
        <div  class="panel panel-default thumbnail">
           ...
           <div class="panel-heading no-print">
                <div class="btn-group"> 
                    <a class="btn btn-primary btn-lg " href="AccountantList.php"> <i class="fa fa-list"></i>  Accountant List </a>  
                </div>
            </div> 
           ...
           <div class="form-group row">
            ...
            <div class="form-group row">
              ...
              header('Location:login.php');
                              ...
                              $stmt = $con ->prepare(" DELETE FROM employees Where id = ? AND Role = 'Accountant' ");
