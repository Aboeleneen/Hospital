 ...
 <?php  
    ...
    global $i;
       $i = 1 ;
    include 'contact.php' ;
   $sql = $con->prepare("SELECT * FROM employees WHERE Role = 'Pharmacist' ");
        $sql->execute();
    ...
    <div class="panel-body"> 
        <div  class="table-responsive ">
               <table class="datatable table table-striped table-bordered"  cellspacing="0" width="100%">
                 <h1 class="btn btn-success btn-block btn-lg" >Pharmacist List </h1>
                <thead>
                        <tr>
                            <th>NO</th>
                            <th>Picture</th>
   ...
   <?php  
        ...
        <tbody>
         ...
         <td><?php echo $row['email'];?></td>                        
             ...
             <td><a  class="btn btn-primary" href="PharmacistList.php?do=Edit&id=<?php echo $row['id'] ?>"> edit</a>
                 <a class="btn btn-danger" href="PharmacistList.php?do=delete&id=<?php echo $row['id'] ?>"> delete</a>
                  <a class="btn btn-info"   href="profile.php?id=<?php echo $row['id'] ?>&user=Employee&Role=Pharmacist"> show</a> </td> 
        </tr>
        <?php } ?></tbody>
      </table>
       </div>
     ...
     <?php   } else if($do == 'Edit'){
         ...
         if($_SESSION['Role'] != "Admin"){
           ...
           $id = $_GET['id'];
           $sql = $con->prepare("SELECT * FROM employees Where id = ? AND Role = 'Pharmacist' ");
                ...
                <div class="col-sm-10">
                    <select name="Role" class="form-control" >
                      <option value="" selected="selected">Select Option</option>
                        ...
                        <option >Nurse</option>
                        <option  selected="selected" >Pharmacist</option>
                ...
                <div class="col-sm-offset-3 col-sm-6">
                   ...
                   <?php    }
                           ...
                           if($_SESSION['Role'] != "Admin"){
                             ...
                             $stmt = $con ->prepare(" DELETE FROM employees Where id = ? AND Role = 'Pharmacist' ");
