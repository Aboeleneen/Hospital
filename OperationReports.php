 ...
 // Operation Report 
   $do = isset($_GET['do']) ? $_GET['do'] : 'manage' ;
    ...
    if($do != 'Edit' and $do !='delete'){
     ...
     global $i;
       $i = 1 ;
        ...
        $sql = $con->prepare("SELECT * FROM operationreports ");
        $sql->execute();
        ?>
                  ...
                  <div  class="panel panel-default thumbnail">
                      ...
                      <div class="panel-heading no-print">
                          <div class="btn-group" style="position: relative;"> 
                              <a class="btn btn-success btn-lg" href="addOperationReport.php"> <i class="fa fa-plus"></i>  Add Operation Report </a>  
              ...
              <div class="panel-body">
                  <div  class="table-responsive ">
                         <table class="datatable table table-striped table-bordered"  cellspacing="0" width="100%">
                           <h1 class="btn btn-success btn-block btn-lg" >Operation Report </h1>
                          <thead>
                                  <tr>
                                      <th>NO</th>
                                      <th>Patient Name</th>
        ...
        ?>
         ...
         <td><a class="btn btn-primary" href="OperationReports.php?do=Edit&id=<?php echo $row['id'] ?>"> edit</a>
              <a class="btn btn-danger" href="OperationReports.php?do=delete&id=<?php echo $row['id'] ?>"> delete</a></td> 
        </tr>
        <?php } ?></tbody>
      </table>
       </div>
     ...
     <?php }else if($do == 'Edit'){
      ...
      if($_SESSION['Role'] != "Admin" AND $_SESSION['Role'] != "Doctor"){
          ...
          $id = $_GET['id'];
           $sql = $con->prepare("SELECT * FROM operationreports Where id = ? ");
           $sql->execute(array($id));
           $row = $sql ->fetch();
           $count =$sql ->rowCount();

            $patient_name = $row['patient_name'];
            $date_of_Operation = $row['date_of_operation'];
            $title = $row['title'];
    ...
    <div class="panel-body panel-form">
            ...
            <form action="addOperationReport.php?do=Edit&id=<?php echo $row['id'] ?>" method="POST" class="form-horizontal" >
              ...
              <label  class="control-label col-sm-2">Date <i class="text-danger">*</i></label>
                <div class="col-sm-10">
                <input type="date" name="date_of_Operation" placeholder="date" value="<?php echo $date_of_Operation ?>" class="datepicker form-control" >
               </div>
            </div> 
             ...
             <div class="form-group row">
              ...
              exit();
                           ...
                           $id = $_GET['id'];
                          $stmt = $con ->prepare(" DELETE FROM operationreports WHERE id=? ");
