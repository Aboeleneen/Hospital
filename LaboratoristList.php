 ...
 <?php   
   ...
   $sql = $con->prepare("SELECT * FROM employees WHERE Role = 'Laboratorist' ");
        $sql->execute();
          ?>
    ...
    <div class="panel-body"> 
        <div  class="table-responsive ">
               <table class="datatable table table-striped table-bordered"  cellspacing="0" width="100%">
                 <h1 class="btn btn-success btn-block btn-lg" >Laboratorist List </h1>
                <thead>
                        <tr>
                            <th>NO</th>
                            <th>Picture</th>
   ...
   <?php    
        ...
        <tbody>
         ...
         <td><?php echo $row['email'];?></td>                        
             ...
             <td><?php echo "Laboratorist";?></td>
             <td><a class="btn btn-primary"  href="LaboratoristList.php?do=Edit&id=<?php echo $row['id'] ?>"> edit</a>
                  <a class="btn btn-danger" href="LaboratoristList.php?do=delete&id=<?php echo $row['id'] ?>"> delete</a>
                   <a class="btn btn-info"   href="profile.php?id=<?php echo $row['id'] ?>&user=Employee&Role=Laboratorist"> show</a> </td> 
        </tr>
         <?php } ?></tbody>
      </table>
       </div>
     ...
     <?php   } else if($do == 'Edit'){
       ...
       if($_SESSION['Role'] != "Admin"){
           ...
           $id = $_GET['id'];
           $sql = $con->prepare("SELECT * FROM employees Where id = ? AND Role = 'Laboratorist' ");
    ...
    <div id="main">
      <?php include 'navbar/navbar.php';?>
        ...
        <div  class="panel panel-default thumbnail">
           ...
           <div class="panel-heading no-print">
                <div class="btn-group"> 
                    <a class="btn btn-primary btn-lg " href=LaboratoristList.php"> <i class="fa fa-list"></i>  Laboratorist List </a>  
                </div>
            </div> 
                ...
                <div class="col-sm-10">
                    <select name="Role" class="form-control" >
                      <option value="" selected="selected">Select Option</option>
                        ...
                        <option selected="selected" >Laboratorist</option>
                        <option >Nurse</option>
              ...
              <label  class="control-label col-sm-2">Address <i class="text-danger">*</i></label>
                ...
                <div class="col-sm-offset-3 col-sm-6">
                   ...
                   <?php    }
                             ...
                             $stmt = $con ->prepare(" DELETE FROM employees Where id = ? AND Role = 'Laboratorist' ");
